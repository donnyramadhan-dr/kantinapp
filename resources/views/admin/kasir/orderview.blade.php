        ...
        <div class="col-8 p-3">
            <div class="card shadow mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-2 mb-4 item-cashier" data-id="{{$food['id_makanan']}}" data-name="{{$food['nama_makanan']}}" data-price="{{$food['harga']}}" data-image="{{$food['foto_makanan']}}">
                        <div style="border: none;" class="card text-center">
                            <img style="border-radius: 15px !important; width: 90px;" class="rounded mx-auto d-block" src="img/{{ $food['foto_makanan'] }}" class="card-img-top" alt="...">
                            <div class="card-body p-2">
                                <h5 class="h6 card-title mb-1 font-weight-bold text-dark">{{ $food['nama_makanan'] }}</h5>
                                <p style="font-size: 12px;" class="card-text text-dark">Rp {{ $food['harga'] }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
